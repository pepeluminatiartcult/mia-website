      ...
      <div className="flex flex-wrap items-end gap-4 mb-8 pb-6 border-b border-border">
        <div>
          ...
          <select
            ...
            className="font-mono text-xs border border-border bg-surface text-foreground px-3 py-1.5 focus:border-accent-bright focus:outline-none"
          >
      ...
      {totalPages > 1 && (
        <div className="flex justify-center gap-1">
          <button
            ...
            disabled={page === 1}
            className="px-4 py-1.5 border border-border bg-surface pixel-text disabled:text-gray-600 hover:border-accent-bright hover:text-accent-bright cursor-pointer disabled:cursor-default disabled:hover:border-border disabled:hover:text-gray-600 transition-colors"
          >
            ← Prev
          </button>
