...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      <div className="pixel-text text-gray-600 mb-2">// ABOUT</div>
      <h1 className="font-mono text-3xl sm:text-4xl font-bold tracking-tighter mb-10">About MIA</h1>

      <section className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          <div className="pixel-text text-accent">WHAT MIA IS</div>
          <div className="flex-1 h-px bg-border" />
        </div>
        <div className="text-sm leading-[1.8] space-y-3 text-gray-400">
          <p>
      ...
      <section className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          <div className="pixel-text text-accent">DUAL MANDATE</div>
          <div className="flex-1 h-px bg-border" />
        </div>
        <div className="text-sm leading-[1.8] space-y-3 text-gray-400">
          <p>
      ...
      <section className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          <div className="pixel-text text-accent">22 DOMAINS</div>
          <div className="flex-1 h-px bg-border" />
        </div>
      ...
      <section className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          <div className="pixel-text text-accent">METHODOLOGY</div>
          <div className="flex-1 h-px bg-border" />
        </div>
        <div className="text-sm leading-[1.8] space-y-3 text-gray-400">
          <p>
      ...
      <section className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          <div className="pixel-text text-accent">PAC CORP</div>
          <div className="flex-1 h-px bg-border" />
        </div>
        <div className="text-sm leading-[1.8] space-y-3 text-gray-400">
          <p>
